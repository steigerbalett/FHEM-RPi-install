...
apt -y install libcryptx-perl avrdude libprotocol-websocket-perl libcpanel-json-xs-perl libio-socket-inet6-perl libperl-prereqscanner-notquitelite-perl
